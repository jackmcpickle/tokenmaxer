...
const CLAUDE = [
  JSON.stringify({ type: "user", timestamp: "2026-07-18T10:00:00Z", sessionId: "sess-abc" }),
  JSON.stringify({
    type: "assistant",
...
describe("sessionIdFromPath", () => {
  it("strips rollout- prefix and .jsonl suffix", () => {
    expect(sessionIdFromPath("/a/b/rollout-2026-07-18T09-00-00-uuid.jsonl")).toBe(
      "2026-07-18T09-00-00-uuid",
    );
