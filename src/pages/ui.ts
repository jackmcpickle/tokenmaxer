// Shared Tailwind / component class bundles for tokenmaxer.quest UI.

export const sub =
    'mb-6 max-w-[52ch] text-[18px] leading-snug tracking-[-0.18px] text-muted';
export const muted = 'text-muted';
export const panel = 'rounded-xl bg-panel p-6';
...
export const btnGhost = 'btn-secondary';
export const btnCopy =
    'btn-secondary absolute top-2 right-2 !min-h-0 px-3 py-1.5 text-xs';

export const pill =
    'inline-block rounded-full bg-panel2 px-2.5 py-1 text-[12px] font-medium text-muted';

export const statGrid = 'grid grid-cols-1 gap-3 sm:grid-cols-2';
export const stat = 'rounded-xl bg-panel p-5';
...
export const notice = 'my-4 rounded-xl bg-panel2 px-4 py-3.5 text-sm text-text';
