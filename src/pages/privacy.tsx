    ...
    >
        ...
        <div className="mx-auto max-w-[65ch]">
            ...
            <ul className="mb-6 list-disc space-y-2 pl-5 text-muted">
                <li>
                    <strong className="text-text">Username</strong> — the public
                    name you chose.
                </li>
                <li>
                    <strong className="text-text">Country</strong> — an ISO
                    country code you pick at signup, shown on your profile and
                    used for the country leaderboard filter.
                </li>
                <li>
                ...
                <li>
                    <strong className="text-text">Optional profile URL</strong>{' '}
                    — an <code>https:</code> link you may add; clearing it
                    removes the link.
                </li>
                <li>
                    <strong className="text-text">
                ...
                <li>
                    <strong className="text-text">A transient IP</strong> — used
